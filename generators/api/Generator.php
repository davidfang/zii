...
namespace yii\gii\generators\api;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'This generator generates a controller and resources that implement RestFull Api (Create, Read, Update, Delete)
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controllerClass', 'modelClass', 'resourcesClass', 'baseControllerClass'], 'filter', 'filter' => 'trim'],
            [['modelClass', 'controllerClass', 'baseControllerClass', 'indexWidgetType'], 'required'],
            [['resourcesClass'], 'compare', 'compareAttribute' => 'modelClass', 'operator' => '!==', 'message' => 'Search Model Class must not be equal to Model Class.'],
            [['modelClass', 'controllerClass', 'baseControllerClass', 'resourcesClass'], 'match', 'pattern' => '/^[\w\\\\]*$/', 'message' => 'Only word characters and backslashes are allowed.'],
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'resourcesClass' => 'This is the name of the resources class to be generated. You should provide a fully
                qualified namespaced class name, e.g., <code>frontend\modules\api\v1\resources\Article</code>.',
...
资源类通过实现<code>yii\web\Linkable </code>接口来支持HATEOAS， 该接口包含方法 <code>getLinks()</code> 来返回 links 列表，典型情况下应返回包含代表本资源对象URL的 self 链接'
    ...
    public function generate()
    {
        ...
        if (!empty($this->resourcesClass)) {
            $searchModel = Yii::getAlias('@' . str_replace('\\', '/', ltrim($this->resourcesClass, '\\') . '.php'));
